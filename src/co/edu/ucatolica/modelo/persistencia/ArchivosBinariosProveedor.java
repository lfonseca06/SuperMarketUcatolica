...
public class ArchivosBinariosProveedor {
	...
	public static String escribirArchivoBinario(Proveedor reg) {
	...
	public static Proveedor[] leerArchivoBinario() {
		f = new File(rutaReg);
		if (!f.exists()) {
			try {
				f.createNewFile();
	...
	public static String modificarProveedor(int NIT, Proveedor nuevoProveedor) {
		String mensaje = "Proveedor modificado exitosamente!";
		Proveedor[] proveedores = leerArchivoBinario();
	...
	public static Proveedor bucarProveedor(int NIT) {
		Proveedor[] leidos = leerArchivoBinario();
		if (leidos != null && leidos.length > 0) {
			System.out.println("Proveedores leídos del archivo:");
	...
	public static void main(String[] args) {
		...
		Proveedor a=bucarProveedor(156);
		System.out.println(a);
		Proveedor x = new Proveedor(156, "pepe", "xd", "a", "sadasd");
		System.out.println(escribirArchivoBinario(x));
		/*Proveedor a = new Proveedor(156, "pepe", "xd", "a", "sadasd");
		System.out.println(escribirArchivoBinario(a));
		...
		Proveedor modificado = new Proveedor(156, "Pepe Modificado", "Direccion Modificada", "Telefono Modificado", "Ciudad Modificada");
		System.out.println(modificarProveedor(156, modificado));

		leidos = leerArchivoBinario();*/
