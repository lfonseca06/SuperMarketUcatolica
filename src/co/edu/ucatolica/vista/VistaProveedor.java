...
public class VistaProveedor extends JFrame {
    ...
    public VistaProveedor(Controlador controlador) {
        setSize(700, 500);
        setResizable(false);
        ...
        panelAgregarProveedores.getBtnAgregar().addActionListener(controlador);
        panelAgregarProveedores.getBtnModificarFinal().addActionListener(controlador);

        panelFuncionesNit.getButBuscarLeer().addActionListener(controlador);
        panelFuncionesNit.getButEliminar().addActionListener(controlador);
        panelFuncionesNit.getButSalir().addActionListener(controlador);
